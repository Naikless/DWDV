...
{
	text[0] = "unknown";
	text[1] = "Slot 1 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (0 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "unknown";
	text[1] = "Slot 2 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (1 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "unknown";
	text[1] = "Slot 3 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (2 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "unknown";
	text[1] = "Slot 4 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (3 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "unknown";
	text[1] = "Slot 5 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (4 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "unknown";
	text[1] = "Slot 6 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (5 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "unknown";
	text[1] = "Slot 7 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (6 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 8 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (7 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 9 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (8 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 10 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (9 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 11 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (10 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 12 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (11 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 13 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (12 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 14 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (13 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
...
{
	text[0] = "---";
	text[1] = "Slot 15 - RETURN zum Laden des gespeicherten Spielstandes.";
	posx = SAVEGAME_X1;
	posy = SAVEGAME_Y + (14 * SAVEGAME_DY);
	dimx = SAVEGAME_DX1;
	dimy = SAVEGAME_DY;
