...
instance VLK_524_Dusty(Npc_Default)
{
	...
	Mdl_SetVisualBody(self,"hum_body_Naked0",19,1,"Hum_Head_Psionic",68,0,-1);
	B_Scale(self);
...
{
	TA_Smalltalk(23,0,4,0,"PSI_PATH_9_11");
	TA_Sleep(4,0,7,45,"PSI_25_HUT_IN");
	TA_Listen(7,45,23,0,"PSI_PLATFORM_1");
};

func void rtn_afterritual_524()
{
	TA_Smalltalk(23,0,4,0,"PSI_PATH_9_11");
	TA_Sleep(4,0,7,45,"PSI_25_HUT_IN");
	TA_Smoke(7,45,23,0,"PSI_PLATFORM_1");
};
