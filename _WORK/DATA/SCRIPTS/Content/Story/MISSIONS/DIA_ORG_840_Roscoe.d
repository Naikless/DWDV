...
instance DIA_ROSCOE_NOWORG(C_Info)
{
	npc = ORG_840_Roscoe;
	nr = 1;
	condition = dia_roscoe_noworg_condition;
	information = dia_roscoe_noworg_info;
	permanent = 0;
	important = 1;
};


func int dia_roscoe_noworg_condition()
{
...
func void dia_roscoe_noworg_info()
{
	AI_Output(self,other,"DIA_Wolf_NowORG_09_00");	//Lares hat dich in die Bande aufgenommen? Nicht schlecht in so kurzer Zeit.
};
