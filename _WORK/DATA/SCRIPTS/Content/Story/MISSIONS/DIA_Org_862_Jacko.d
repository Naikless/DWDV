...
func void org_862_jacko_drugguard_info()
{
	...
	B_LogEntry(CH1_DrugMonopol,"Ich habe die geheime Sumpfkrautproduktion gefunden. Renyu, Jacko und Killian stellen die Stängel her.");
	AI_StopProcessInfos(self);
};
...
instance ORG_862_JACKO_KILL(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Um der Sache hier ein Ende zu bereiten!";
};
...
instance ORG_862_JACKO_TEMPLAR(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Ich will euch warnen. Cor Kalom hat fünf Templer geschickt.";
};
