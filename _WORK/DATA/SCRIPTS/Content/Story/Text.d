...
const string MOBNAME_TORCHBURNING = "Brennende Fackel";
...
const string MOBNAME_BOOK = "Buchständer";
...
const string TXT_SPELLS[59] =
{
	...
	"Feuerregen",
	"n/a",
	"Teleport Feuermagier",
	"Teleport Wassermagier",
	"Teleport Dämonenbeschwörer",
	"Orkischer Teleport",
	"Teleport Sumpflager",
...
const string NAME_ManaPerSec = "Mana pro Sek.";
...
const string NAME_DamagePerSec = "Schaden pro Sek.";
...
const string NAME_XPGained = "Erfahrung + ";
const string NAME_LevelUp = "Stufe gestiegen!";
...
const string _STR_MESSAGE_ITEM_GIVEN = " Gegenstand gegeben";
...
const string NAME_NAMIBHEAVYNOVICE = "Novizenrüstung. Schutz: Waffen 40, Pfeile 5, Feuer 20";
const string NAME_NAMIBNOVICE = "Leichte Novizenrüstung. Schutz: Waffen 30, Pfeile 0, Feuer 15";
...
const string NAME_ATTRIBUTLEARNPOSTFIX = " bereits gelernt)";
const string NAME_ATTRIBUTLEARNMIDFIXS = " Lernpunkt, ";
const string NAME_ATTRIBUTLEARNMIDFIXP = " Lernpunkte, ";
