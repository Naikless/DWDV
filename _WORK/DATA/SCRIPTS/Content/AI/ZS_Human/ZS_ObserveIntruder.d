...
func int ZS_ObserveIntruderWaitNeutral_Loop()
{
	...
	if(((Npc_GetDistToNpc(self,other) > HAI_DIST_CLEARROOM) && ((self.guild == Wld_GetPlayerPortalGuild()) || (Wld_GetGuildAttitude(self.guild,Wld_GetPlayerPortalGuild()) == ATT_FRIENDLY))) || (Npc_GetDistToNpc(self,other) > HAI_DIST_OBSERVEINTRUDER))
	{
		return LOOP_END;
	};
