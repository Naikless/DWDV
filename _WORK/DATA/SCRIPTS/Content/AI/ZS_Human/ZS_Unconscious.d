...
func void ZS_Unconscious()
{
	...
	Mdl_ApplyRandomAniFreq(self,"S_WOUNDEDB",10);
...
func int ZS_Unconscious_Loop()
{
	...
	if((Npc_GetStateTime(self) > HAI_TIME_UNCONSCIOUS) || (((self.attribute[ATR_HITPOINTS_MAX] / 10) < self.attribute[ATR_HITPOINTS]) && (Npc_GetStateTime(self) > (HAI_TIME_UNCONSCIOUS / 2))))
	{
