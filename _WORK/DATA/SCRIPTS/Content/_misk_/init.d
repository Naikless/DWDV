...
{
	var int heldengilde;
	heldengilde = Npc_GetTrueGuild(hero);
	if((heldengilde == GIL_STT) || (heldengilde == GIL_GRD) || (heldengilde == GIL_EBR) || (heldengilde == GIL_ORG) || (heldengilde == GIL_SLD) || (heldengilde == GIL_KDF) || (heldengilde == GIL_KDW) || (heldengilde == GIL_DMB))
	{
...
func void init3()
{
	if(Kapitel >= 2)
	{
		Mdl_SetVisualBody(VLK_582_Melvin,"hum_body_Naked0",1,1,"Hum_Head_FatBald",119,3,-1);
...
func void init4()
{
	...
	{
		Mdl_SetVisualBody(VLK_524_Dusty,"hum_body_Naked0",1,1,"Hum_Head_Psionic",120,0,-1);
...
func void init5()
{
	if(Kapitel >= 2)
	{
		Mdl_SetVisualBody(Vlk_580_Grim,"hum_body_Naked0",0,1,"Hum_Head_Thief",72,2,-1);
...
func void init6()
{
	if(MESSAGE_GET == FALSE)
	{
		...
		B_LogEntry(CH1_MESSAGEKDF,"Kurz bevor ich in die Kolonie geworfen wurde, bekam ich eine Nachricht von einem Feuermagier. Ich soll die Nachricht dem Obersten Feuermagier bringen, der sich innerhalb der Barriere aufhält.");
		MESSAGE_GET = TRUE;
	};
};
...
func void init7()
{
	...
	{
		Mdl_SetModelFatness(hero,0.3);
	};
	if((hero.attribute[ATR_STRENGTH] < 100) && ((Npc_GetTrueGuild(hero) == GIL_NOV) || (Npc_GetTrueGuild(hero) == GIL_TPL) || (Npc_GetTrueGuild(hero) == GIL_GUR)))
	{
		Mdl_SetModelFatness(hero,-0.3);
	};
};
...
func void init8()
{
	if((oldHeroGuild == GIL_STT) || (oldHeroGuild == GIL_KDF) || (oldHeroGuild == GIL_GRD) || (oldHeroGuild == GIL_EBR))
	{
		Mdl_SetVisualBody(hero,"hum_body_Naked0",0,1,"HUM_HEAD_Pony",9,2,-1);
	};
};
...
func void init9()
{
	if((Kapitel == 1) && (Npc_GetTrueGuild(other) == GIL_None) && (THIRTYDAYS_COLONY <= (Wld_GetDay() - 30)) && (THIRTYDAYS_COLONY != LOG_SUCCESS))
	{
		THIRTYDAYS_COLONY = LOG_SUCCESS;
		Log_CreateTopic(CH1_THIRTYDAYS,LOG_MISSION);
		Log_SetTopicStatus(CH1_THIRTYDAYS,LOG_SUCCESS);
		B_LogEntry(CH1_THIRTYDAYS,"Mein 30. Tag in der Kolonie und ich sitze immer noch hier drin fest. Ich habe schon einiges durchgemacht, aber bisher habe ich noch keinen Weg gefunden, wie ich meine Freiheit zurück erlange. Bisher habe ich noch nicht sehr viel hier drin erreicht. Vielleicht sollte ich mich langsam an den Gedanken gewöhnen, dass ich mein restliches Leben in der Kolonie verbringen werde.");
...
func void init10()
{
	if((Npc_GetTrueGuild(hero) == GIL_GRD) || (Npc_GetTrueGuild(hero) == GIL_SLD) || (oldHeroGuild == GIL_GRD))
	{
		Mdl_ApplyOverlayMds(hero,"Humans_Militia.mds");
	};
	if((Npc_GetTrueGuild(hero) == GIL_ORG) || (Npc_GetTrueGuild(hero) == GIL_STT))
	{
		Mdl_ApplyOverlayMds(hero,"Humans_Relaxed.mds");
	};
	if((Npc_GetTrueGuild(hero) == GIL_KDF) || (Npc_GetTrueGuild(hero) == GIL_KDW) || (Npc_GetTrueGuild(hero) == GIL_NOV) || (Npc_GetTrueGuild(hero) == GIL_TPL) || (Npc_GetTrueGuild(hero) == GIL_GUR) || (Npc_GetTrueGuild(hero) == GIL_DMB) || (oldHeroGuild == GIL_KDF))
	{
		Mdl_ApplyOverlayMds(hero,"Humans_Mage.mds");
	};
	if((Npc_GetTrueGuild(hero) == GIL_EBR) || (oldHeroGuild == GIL_EBR))
	{
...
func void Startup_Sub_Psicamp()
{
	...
	Wld_InsertNpc(gur_5021_baallukor,"PSI_START");
	...
	Wld_InsertNpc(nov_5012_novize,"PSI_START");
	Wld_InsertNpc(nov_5013_novize,"PSI_START");
	Wld_InsertNpc(nov_5022_novize,"PSI_START");
	Wld_InsertNpc(nov_5023_novize,"PSI_START");
	Wld_InsertNpc(nov_5024_novize,"PSI_START");
	Wld_InsertNpc(nov_5025_novize,"PSI_START");
	Wld_InsertNpc(nov_5048_novize,"PSI_START");
	Wld_InsertNpc(nov_5049_novize,"PSI_START");
	...
	Wld_InsertNpc(nov_5062_novize,"PSI_START");
	Wld_InsertNpc(nov_5063_novize,"PSI_START");
	Wld_InsertNpc(nov_5064_novize,"PSI_START");
	...
	Wld_InsertNpc(tpl_5026_gorboba,"PSI_START");
	Wld_InsertNpc(tpl_5051_templer,"PSI_START");
	Wld_InsertNpc(tpl_5052_templer,"PSI_START");
...
func void INIT_Sub_Psicamp()
{
	...
	Wld_SetObjectRoutine(0,0,"FIREPLACE_MIDDLE_VOBTREE",1);
	Wld_SetObjectRoutine(20,0,"FIREPLACE_MIDDLE_VOBTREE",1);
	Wld_SetObjectRoutine(5,0,"FIREPLACE_MIDDLE_VOBTREE",1);
	Wld_SetObjectRoutine(0,0,"PSI_FIREPLACE_GROUND_01",1);
	Wld_SetObjectRoutine(20,0,"PSI_FIREPLACE_GROUND_01",1);
	Wld_SetObjectRoutine(5,0,"PSI_FIREPLACE_GROUND_01",0);
	Wld_SetObjectRoutine(0,0,"TEMPLE_FIREPLACE_PCHIGH2_01",1);
	Wld_SetObjectRoutine(20,0,"TEMPLE_FIREPLACE_PCHIGH2_01",1);
	Wld_SetObjectRoutine(5,0,"TEMPLE_FIREPLACE_PCHIGH2_01",0);
	Wld_SetObjectRoutine(0,0,"TEMPLE_FIREPLACE_PCHIGH2_02",1);
	Wld_SetObjectRoutine(20,0,"TEMPLE_FIREPLACE_PCHIGH2_02",1);
	Wld_SetObjectRoutine(5,0,"TEMPLE_FIREPLACE_PCHIGH2_02",0);
	Wld_SetObjectRoutine(0,0,"TEMPLE_FIREPLACE_PCHIGH2_03",1);
	Wld_SetObjectRoutine(20,0,"TEMPLE_FIREPLACE_PCHIGH2_03",1);
	Wld_SetObjectRoutine(5,0,"TEMPLE_FIREPLACE_PCHIGH2_03",0);
	Wld_SetObjectRoutine(0,0,"TEMPLE_FIREPLACE_PCHIGH2_04",1);
	Wld_SetObjectRoutine(20,0,"TEMPLE_FIREPLACE_PCHIGH2_04",1);
	Wld_SetObjectRoutine(5,0,"TEMPLE_FIREPLACE_PCHIGH2_04",0);
	...
	Wld_SetObjectRoutine(20,0,"PSI_FIREPLACE_GROUND_01",1);
	Wld_SetObjectRoutine(5,0,"PSI_FIREPLACE_GROUND_01",0);
	Wld_SetObjectRoutine(0,0,"PSI_FIREPLACE_GROUND_02",1);
	Wld_SetObjectRoutine(20,0,"PSI_FIREPLACE_GROUND_02",1);
	Wld_SetObjectRoutine(5,0,"PSI_FIREPLACE_GROUND_02",0);
	...
	Wld_AssignRoomToGuild("psih23",GIL_NOV);
...
func void Startup_Sub_Newcamp()
{
	...
	Wld_InsertNpc(BAU_925_Bauer,"NC_DAM");
	Wld_InsertNpc(BAU_926_Bauer,"NC_DAM");
...
func void INIT_Sub_Newcamp()
{
	...
	Wld_AssignRoomToGuild("MAGE02",GIL_KDW);
...
func void Startup_Sub_Oldcamp()
{
	...
	Wld_InsertNpc(grd_5050_gardist,"OC1");
	Wld_InsertNpc(grd_5074_gardist,"OC1");
	Wld_InsertNpc(grd_5075_gardist,"OC1");
	Wld_InsertNpc(grd_5076_gardist,"OC1");
	Wld_InsertNpc(grd_5014_convoitraeger,"OC1");
	Wld_InsertNpc(grd_5015_convoitraeger,"OC1");
	Wld_InsertNpc(grd_5016_convoiwache,"OC1");
	Wld_InsertNpc(grd_5017_convoiwache,"OC1");
	Wld_InsertNpc(grd_5018_ramon,"OC1");
	...
	Wld_InsertNpc(stt_5027_brago,"OC1");
...
func void INIT_Sub_Oldcamp()
{
	...
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_05",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_05",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_05",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_06",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_06",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_06",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_07",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_07",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_07",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_08",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_08",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_08",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_10",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_10",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_10",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_11",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_11",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_11",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_12",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_12",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_12",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_13",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_13",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_13",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_14",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_14",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_14",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_15",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_15",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_15",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_16",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_16",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_16",1);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_17",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_17",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_17",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_18",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_18",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_18",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_20",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_20",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_20",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_21",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_21",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_21",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_22",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_22",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_22",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_23",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_23",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_23",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_24",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_24",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_24",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_25",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_25",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_25",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_26",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_26",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_26",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_27",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_27",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_27",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_28",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_28",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_28",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_29",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_29",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_29",0);
	Wld_SetObjectRoutine(0,0,"OC_FIREPLACE_MIDDLE_30",1);
	Wld_SetObjectRoutine(20,0,"OC_FIREPLACE_MIDDLE_30",1);
	Wld_SetObjectRoutine(5,0,"OC_FIREPLACE_MIDDLE_30",1);
	...
	Wld_AssignRoomToGuild("EG1",GIL_GRD);
	Wld_AssignRoomToGuild("EG2",GIL_GRD);
	Wld_AssignRoomToGuild("EG3",GIL_GRD);
	Wld_AssignRoomToGuild("EG4",GIL_GRD);
	Wld_AssignRoomToGuild("EG5",GIL_GRD);
	Wld_AssignRoomToGuild("KEL1",GIL_GRD);
	Wld_AssignRoomToGuild("ocgateb",GIL_GRD);
	Wld_AssignRoomToGuild("tsp1",GIL_VLK);
	Wld_AssignRoomToGuild("hütte1",GIL_VLK);
...
{
	Wld_AssignRoomToGuild("FMC01",GIL_SLD);
	Wld_AssignRoomToGuild("FMC03",GIL_SLD);
	Wld_AssignRoomToGuild("FMC04",GIL_SLD);
	Wld_AssignRoomToGuild("FMC05",GIL_SLD);
	Wld_AssignRoomToGuild("FMC06",GIL_SLD);
	Wld_AssignRoomToGuild("FMC07",GIL_SLD);
	Wld_AssignRoomToGuild("FMC08",GIL_SLD);
	Wld_AssignRoomToGuild("FMC09",GIL_SLD);
	Wld_AssignRoomToGuild("FMC10",GIL_SLD);
	Wld_AssignRoomToGuild("FMC11",GIL_SLD);
	Wld_AssignRoomToGuild("FMC12",GIL_SLD);
	Wld_AssignRoomToGuild("FMC13",GIL_SLD);
	Wld_AssignRoomToGuild("FMC14",GIL_SLD);
	Wld_AssignRoomToGuild("FMC15",GIL_SLD);
};
...
func void Startup_Sub_Surface()
{
	...
	Wld_InsertNpc(vlk_5045_buddler,"OC1");
	Wld_InsertNpc(vlk_5046_buddler,"OC1");
	Wld_InsertNpc(grd_5028_gardist,"OC1");
	Wld_InsertNpc(grd_5029_gardist,"OC1");
	Wld_InsertNpc(stt_5030_schatten,"OC1");
	Wld_InsertNpc(stt_5031_schatten,"OC1");
	Wld_InsertNpc(grd_5032_carlos,"OC1");
	...
	Wld_InsertNpc(org_5060_bandit,"SPAWN_SIT_OW");
	Wld_InsertNpc(org_5061_bandit,"HELPPOINT10");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_AL_HILL01");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_AL_HILL02");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_AL_HILL03");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_MSCAVENGER_1");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_MSCAVENGER_2");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_MSCAVENGER_3");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_SNAPPER_1");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_SNAPPER_2");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_SNAPPER_3");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_SNAPPER_4");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_SNAPPER_5");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_SNAPPER_6");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_MOUNTAIN_SCAVENGER_1");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_MOUNTAIN_SCAVENGER_2");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_MOUNTAIN_SCAVENGER_3");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_MOUNTAIN_SCAVENGER_4");
	Wld_InsertNpc(FireWaran,"FP_ROAM_OW_MOUNTAIN_FIREWARAN_1");
	Wld_InsertNpc(FireWaran,"FP_ROAM_OW_MOUNTAIN_FIREWARAN_2");
	Wld_InsertNpc(GRD_282_Nek,"");
	Nek = Hlp_GetNpc(GRD_282_Nek);
	Npc_ChangeAttribute(Nek,ATR_HITPOINTS,-Nek.attribute[ATR_HITPOINTS_MAX]);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_01",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_01",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_01",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_02",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_02",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_02",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_03",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_03",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_03",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_04",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_04",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_04",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_05",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_05",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_05",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_06",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_06",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_06",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_07",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_07",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_07",1);
	Wld_SetObjectRoutine(0,0,"OW_FIREPLACE_GROUND_08",1);
	Wld_SetObjectRoutine(20,0,"OW_FIREPLACE_GROUND_08",1);
	Wld_SetObjectRoutine(5,0,"OW_FIREPLACE_GROUND_08",1);
	Wld_SetObjectRoutine(0,0,"GOBBO_FIREPLACE_GROUND2_01",1);
	Wld_SetObjectRoutine(20,0,"GOBBO_FIREPLACE_GROUND2_01",1);
	Wld_SetObjectRoutine(5,0,"GOBBO_FIREPLACE_GROUND2_01",1);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_01",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_01",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_01",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_02",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_02",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_02",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_03",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_03",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_03",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_04",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_04",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_04",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_05",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_05",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_05",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_06",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_06",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_06",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_07",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_07",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_07",0);
	Wld_SetObjectRoutine(0,0,"RC_FIREPLACE_PCHIGH2_08",1);
	Wld_SetObjectRoutine(20,0,"RC_FIREPLACE_PCHIGH2_08",1);
	Wld_SetObjectRoutine(5,0,"RC_FIREPLACE_PCHIGH2_08",0);
	...
	Wld_InsertNpc(ORG_888_Erpresser,"OW_PATH_259");
	Wld_InsertNpc(ORG_889_CoErpresser,"OW_PATH_259");
	Wld_InsertNpc(Wolf,"FP_ROAM_OW_WOLF_PLACE01");
	Wld_InsertNpc(Shadowbeast,"FP_ROAM_SHADOWBEAST_PLATEU_NEARCASTLERUIN6_2");
	Wld_InsertNpc(Org_858_Quentin,"LOCATION_11_08");
	Wld_InsertNpc(org_863_skinner,"LOCATION_11_08");
	Wld_InsertNpc(org_864_esteban,"LOCATION_11_08");
	Wld_InsertNpc(Org_865_Raeuber,"LOCATION_11_08");
	Wld_InsertNpc(org_866_franco,"LOCATION_11_08");
	Wld_InsertNpc(org_867_sancho,"LOCATION_11_08");
	Wld_InsertNpc(Org_868_Raeuber,"LOCATION_11_08");
	Wld_InsertNpc(org_869_senyan,"LOCATION_11_08");
	Wld_InsertNpc(Org_870_Raeuber,"LOCATION_11_08");
	Wld_InsertNpc(org_871_logan,"LOCATION_11_08");
	...
	Wld_InsertNpc(vlk_5008_buddler,"OW_OM_ENTRANCE03");
	Wld_InsertNpc(vlk_5009_buddler,"OW_OM_ENTRANCE03");
	Wld_InsertNpc(vlk_5010_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5011_gardist,"OW_OM_ENTRANCE02_WHEEL");
	Wld_InsertNpc(vlk_5034_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(vlk_5035_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(vlk_5070_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(vlk_5071_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(vlk_5073_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(vlk_5077_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(vlk_5078_buddler,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5072_gardist,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(stt_5036_miguel,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5037_garaz,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5038_gardist,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5039_gardist,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(stt_5040_schatten,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(stt_5041_schatten,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5068_gardist,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(grd_5069_gardist,"OW_OM_ENTRANCE02");
	Wld_InsertNpc(Bloodhound,"OW_PATH_012");
	Wld_InsertNpc(Bloodhound,"PATH_CASTLE_TO_WATERFALL");
	Wld_InsertNpc(Razor,"FP_ROAM_OW_RAZOR_02_05");
	Wld_InsertNpc(Razor,"FP_ROAM_OW_RAZOR_02_06");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_NEAR_FMC01");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_NEAR_FMC02");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_NEAR_FMC03");
	Wld_InsertNpc(mscavenger,"FP_ROAM_OW_SCAVENGER_NEAR_FMC04");
	Wld_InsertNpc(Molerat,"FP_ROAM_OW_MOLERAT_NEAR_NC01");
	Wld_InsertNpc(Molerat,"FP_ROAM_OW_MOLERAT_NEAR_NC02");
	Wld_InsertNpc(Scavenger,"FP_ROAM_OW_SCAVENGER_NEAR_NC01");
	Wld_InsertNpc(Scavenger,"FP_ROAM_OW_SCAVENGER_NEAR_NC02");
	Wld_InsertNpc(Scavenger,"FP_ROAM_OW_SCAVENGER_NEAR_NC03");
	Wld_InsertNpc(Scavenger,"FP_ROAM_OW_SCAVENGER_NEAR_NC04");
	Wld_InsertNpc(OrcDog,"OW_FOREST_WP_01");
	Wld_InsertNpc(OrcDog,"OW_FOREST_WP_03");
	Wld_InsertNpc(OrcDog,"OW_FOREST_WP_03");
	Wld_InsertNpc(Wolf,"PATH_OC_FOGTOWER07");
	Wld_InsertNpc(Wolf,"PATH_OC_FOGTOWER07");
	Wld_InsertNpc(Bloodhound,"PATH_CASTLE_TO_WATERFALL");
	...
	Wld_InsertNpc(Scavenger,"OW_PATH_006");
	Wld_InsertNpc(Scavenger,"OW_PATH_006");
	Wld_InsertNpc(Scavenger,"OW_SCAVENGER_SPAWN_TREE");
	Wld_InsertNpc(Wolf,"OW_PATH_007");
	Wld_InsertNpc(Wolf,"OW_PATH_007");
	Wld_InsertNpc(Meatbug,"OW_PATH_1_5_13");
	Wld_InsertNpc(Meatbug,"PATH_OC_NC");
	Wld_InsertNpc(Meatbug,"PATH_OC_NC");
	Wld_InsertNpc(Meatbug,"FP_ROAM_OW_MEATBUG_MINE_01");
	Wld_InsertNpc(Meatbug,"FP_ROAM_OW_MEATBUG_MINE_02");
	Wld_InsertNpc(Meatbug,"OW_PATH_RUIN");
	Wld_InsertNpc(Meatbug,"OW_PATH_RUIN");
	Wld_InsertNpc(Meatbug,"OC_ROUND_1");
	Wld_InsertNpc(Meatbug,"OC_ROUND_1");
	Wld_InsertNpc(Molerat,"FP_NC_WATER_MOLERAT_1");
	Wld_InsertNpc(Molerat,"FP_NC_WATER_MOLERAT_2");
	Wld_InsertNpc(Bloodfly,"OW_PATH_233");
	Wld_InsertNpc(Bloodfly,"OW_PATH_233");
	Wld_InsertNpc(Bloodfly,"OW_PATH_234");
	Wld_InsertNpc(Waran,"OW_PATH_WOLF05_SPAWN02");
	Wld_InsertNpc(Waran,"OW_PATH_WOLF05_SPAWN02");
	Wld_InsertNpc(Waran,"OW_PATH_WOLF05_SPAWN02");
	Wld_InsertNpc(Waran,"OW_PATH_008");
	Wld_InsertNpc(Waran,"OW_PATH_008");
	...
	Wld_InsertNpc(FireWaran,"SPAWN_OW_FIREWARAN_BEACH_01");
	Wld_InsertNpc(FireWaran,"SPAWN_OW_FIREWARAN_BEACH_01");
	Wld_InsertNpc(Lurker,"FP_OCR_LAKE_1");
	Wld_InsertNpc(Scavenger,"OW_SCAVENGER_AL_NL_SPAWN");
	Wld_InsertNpc(Scavenger,"OW_SCAVENGER_AL_NL_SPAWN");
	Wld_InsertNpc(Scavenger,"OW_PATH_182");
	Wld_InsertNpc(Scavenger,"OW_PATH_182");
	Wld_InsertNpc(Wolf,"FP_ROAM_OW_WOLF_PLATEU01_01");
	Wld_InsertNpc(Wolf,"FP_ROAM_OW_WOLF_PLATEU01_02");
	Wld_InsertNpc(Bloodhound,"OW_PATH_033_TO_CAVE5");
	Wld_InsertNpc(Snapper,"OW_PATH_093");
	Wld_InsertNpc(Snapper,"OW_PATH_093");
	Wld_InsertNpc(Snapper,"OW_PATH_093");
	...
	Wld_InsertNpc(Razor,"SPAWN_OW_SNAPPER_CAVE_DM");
	Wld_InsertNpc(Razor,"SPAWN_OW_SNAPPER_CAVE_DM");
	Wld_InsertNpc(Zombie,"OW_CAVE_ZOMBIE_1");
	Wld_InsertNpc(Zombie2,"OW_CAVE_ZOMBIE_2");
	Wld_InsertNpc(Zombie4,"OW_CAVE_ZOMBIE_3");
	...
	Wld_InsertNpc(Molerat,"SPAWN_OW_MOLERAT_PSI_PATH7_MOVEMENT2");
	Wld_InsertNpc(Molerat,"SPAWN_OW_MOLERAT_PSI_PATH7_MOVEMENT2");
	Wld_InsertNpc(Razor,"FP_ROAM_OW_SNAPPER_FMC3");
	Wld_InsertNpc(Razor,"FP_ROAM_OW_SNAPPER_FMC2");
	Wld_InsertNpc(Razor,"FP_ROAM_OW_SNAPPER_FMC1");
	Wld_InsertNpc(Lurker,"FP_ROAM_OW_LUKER_CAVE");
	...
	Wld_InsertNpc(BlackGobboMace,"GOBBO_MASTERCAVE10");
	Wld_InsertNpc(BlackGobboMace,"GOBBO_MASTERCAVE10");
	Wld_InsertNpc(BlackGobboMace,"FP_LOCATION_RUIN_GOBLIN_1");
	Wld_InsertNpc(BlackGobboMace,"FP_LOCATION_RUIN_GOBLIN_2");
	Wld_InsertNpc(BlackGobboWarrior,"FP_LOCATION_RUIN_GOBLIN_3");
	...
	Wld_InsertNpc(Bloodfly,"SPAWN_BLOODFLYPATH_OC_PSI_14");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_WARAN_MOUNTAIN_PSI_PATH01");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_WARAN_MOUNTAIN_PSI_PATH03");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_WARAN_MOUNTAIN_PSI_PATH06");
	Wld_InsertNpc(Snapper,"FP_ROAM_OW_WARAN_MOUNTAIN_PSI_PATH05");
	...
	Wld_InsertNpc(org_5033_gestath,"OW_PATH_3002_MOVE9");
	...
	Wld_InsertNpc(non_5042_wegelagerer,"OW_PATH_PLATEU_BDT_05");
	Wld_InsertNpc(non_5043_wegelagerer,"OW_PATH_PLATEU_BDT_05");
	Wld_InsertNpc(non_5044_wegelagerer,"OW_PATH_PLATEU_BDT_05");
	Wld_InsertNpc(non_5057_wegelagerer,"LOCATION_02_04_01");
	Wld_InsertNpc(non_5058_wegelagerer,"LOCATION_02_04_01");
	...
	Wld_InsertNpc(Shadowbeast,"FP_ROAM_BLOODHOUND_PLATEU_NEARCASTLERUIN6_2");
	...
	Wld_InsertNpc(OrcBiter,"OW_PATH_103");
	Wld_InsertNpc(mscavenger,"SPAWN_OW_WOLF_NEAR_SHADOW3");
	Wld_InsertNpc(mscavenger,"SPAWN_OW_WOLF_NEAR_SHADOW3");
...
func void startup_orctempel()
{
	...
	Wld_InsertNpc(tpl_5055_gorhanis,"TPL_408");
	Wld_InsertNpc(tpl_5056_gornaran,"TPL_408");
...
func void startup_oldmine()
{
	...
	Wld_InsertNpc(vlk_5059_garret,"OM_133");
	...
	Wld_InsertNpc(MineCrawler,"OM_084_QUEEN");
	Wld_InsertNpc(MineCrawler,"OM_070");
	Wld_InsertNpc(MineCrawler,"OM_070");
	Wld_InsertNpc(MineCrawler,"OM_132");
	Wld_InsertNpc(MineCrawler,"OM_132");
