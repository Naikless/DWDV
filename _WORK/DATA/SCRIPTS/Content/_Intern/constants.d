...
const int GIL_None = 0; // keine Gilde
const int GIL_HUMAN = 1; // Mensch(?)
const int GIL_EBR = 1; // Erzbaron
const int GIL_GRD = 2; // Gardist
const int GIL_STT = 3; // Schatten
const int GIL_KDF = 4; // Feuermagier
const int GIL_VLK = 5; // Buddler
const int GIL_KDW = 6; // Wassermagier
const int GIL_SLD = 7; // Söldner
const int GIL_ORG = 8; // Bandit
const int GIL_BAU = 9; // Bauer
const int GIL_SFB = 10; // Schürfer
const int GIL_GUR = 11; // Guru
const int GIL_NOV = 12; // Novize
const int GIL_TPL = 13; // Templer
const int GIL_DMB = 14; // Dämonenbeschwörer
const int GIL_BAB = 15; // Babe
