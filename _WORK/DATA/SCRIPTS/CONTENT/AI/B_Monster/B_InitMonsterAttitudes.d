...
func void B_InitMonsterAttitudes()
{
	...
	B_SetGuildAttitude(GIL_WOLF,ATT_HOSTILE,GIL_SCAVENGER);
	...
	B_SetGuildAttitude(GIL_BAU,ATT_FRIENDLY,GIL_DEMON);
	B_SetGuildAttitude(GIL_BAU,ATT_NEUTRAL,GIL_MINECRAWLER);
	B_SetGuildAttitude(GIL_BAU,ATT_NEUTRAL,GIL_SKELETON);
	B_SetGuildAttitude(GIL_BAU,ATT_NEUTRAL,GIL_UNDEADORC);
	B_SetGuildAttitude(GIL_BAU,ATT_NEUTRAL,GIL_ZOMBIE);
	B_SetGuildAttitude(GIL_DEMON,ATT_FRIENDLY,GIL_BAU);
	B_SetGuildAttitude(GIL_MINECRAWLER,ATT_NEUTRAL,GIL_BAU);
	B_SetGuildAttitude(GIL_SKELETON,ATT_NEUTRAL,GIL_BAU);
	B_SetGuildAttitude(GIL_UNDEADORC,ATT_NEUTRAL,GIL_BAU);
	B_SetGuildAttitude(GIL_ZOMBIE,ATT_NEUTRAL,GIL_BAU);
