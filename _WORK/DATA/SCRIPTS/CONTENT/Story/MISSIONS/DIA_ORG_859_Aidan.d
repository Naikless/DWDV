...
func void Org_859_Aidan_Creatures_Zahn()
{
	...
	if(Npc_HasItems(other,ItMiNugget) >= 50)
	{
		...
		{
			AI_Output(self,other,"Org_859_Aidan_Creatures_KEINE_LP_13_00");	//Du mußt mehr Erfahrung sammeln, vorher wird dich mein Wissen nicht weiterbringen.
...
func void dia_aidan_blackwolf_info()
{
	...
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_01");	//Was... was ist das für ein Fell?
	...
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_05");	//Vor einigen Jahren, als das Neue Lager gerade fertig geworden war, gab es eine Gruppe Jäger.
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_06");	//Gute Leute. Sehr erfahren mit dem Leben in der Wildnis.
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_07");	//Naja, es gab eine ganze Zeit lang Gerüchte über einen schwarzen Wolf, der im Wald im Osten der Kolonie umherzog.
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_08");	//Als die Gruppe das hörte, zogen sie los um den Wolf zu jagen. Ich war damals schon Jäger, aber nicht erfahren genug um mit ihnen zu gehen.
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_09");	//Was im Nachhinein nichts schlechtes war...
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_10");	//Wochen vergingen. Die Jäger kehrten ab und an ins Lager zurück um Vorräte zu sammeln. Irgendwann... kehrten sie nicht mehr zurück.
	...
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_15");	//Dieser Bogen hier, er gehörte dem Anführer der Jagdgruppe. Vor langer Zeit fand ich ihn im Osten der Kolonie, an der Steilküste.
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_16");	//Ich bin mir sicher, du wirst ihn gut gebrauchen können. Marus hätte bestimmt nichts dagegen, wenn ich einem erfahrenen Jäger seinen Bogen gebe.
	AI_Output(self,other,"DIA_Aidan_BlackWolf_13_17");	//Danke nochmal für deine Arbeit.
	...
	B_LogEntry(CH1_BLACKWOLF,"Aidan war sehr beeindruckt, dass ich den schwarzen Wolf erledigt hatte, den er schon so lange gejagt hatte. Er erzählte mir davon, wie vor mir eine Gruppe Jäger in die Kolonie zog um den Wolf zu jagen. Aber sie kehrten nie wieder zurück. Dabei dürfte es sich wohl um das verlassene Jägerlager im Osten der Kolonie handeln. Als Belohnung bekam ich einen besonderen Bogen mit ein paar Pfeilen.");
