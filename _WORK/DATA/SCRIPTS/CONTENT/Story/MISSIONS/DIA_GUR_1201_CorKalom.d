...
func void GUR_1201_CorKalom_Experimente_Info()
{
	...
	{
		AI_Output(self,other,"GUR_1201_CorKalom_Experimente_10_01");	//Meine Forschung befindet sich auf einer Ebene, von der du nichts verstehst, Bursche. Also verschwende nicht meine Zeit!
		AI_Output(self,other,"GUR_1201_CorKalom_Experimente_10_02");	//Außerdem untersuche ich die verschiedenen Auswirkungen von Sumpfkraut, wenn man es mit unterschiedlichen Zutaten mischt.
	};
};
...
func void GUR_1201_CorKalom_JoinPSI_Info()
{
	...
	{
		AI_Output(other,self,"GUR_1201_CorKalom_JoinPSI_16_04");	//Baal Lukor will das ich zu einem Diener des Schläfers ausgebildet werde.
		counter = counter + 1;
	};
...
func void GUR_1201_CorKalom_JoinPSI2_Info()
{
	...
	AI_Output(self,other,"GUR_1201_CorKalom_JoinPSI_11_15");	//Ich gebe dir dieses Amulett mit. Wenn du es trägst, werden dich Gomez Schergen als einen der unseren erkennen.
...
func void Info_CorKalom_BringMCQBalls_Success_Info()
{
	...
	Info_AddChoice(Info_CorKalom_BringMCQBalls_Success,"Heilmittel.(Bonus für maximale Lebensenergie)",Info_CorKalom_BringMCQBalls_Success_HEAL);
	Info_AddChoice(Info_CorKalom_BringMCQBalls_Success,"Erz.",Info_CorKalom_BringMCQBalls_Success_ORE);
	Info_AddChoice(Info_CorKalom_BringMCQBalls_Success,"Manatrank. (Bonus für maximales Mana)",Info_CorKalom_BringMCQBalls_Success_MANA);
};
...
func void gur_1201_corkalom_tattoos_info()
{
	...
	B_LogEntry(CH1_RITUAL,"Cor Kalom erwähnte das Baal Namib im Sumpfgebiet auf mich wartet. Er wollte mir aber wie immer nicht sagen, worum es genau geht.");
