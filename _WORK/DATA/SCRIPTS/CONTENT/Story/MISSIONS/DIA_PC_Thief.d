...
func void Info_Diego_Brief_Info()
{
	...
	B_LogEntry(CH1_MESSAGEKDF,"Die Feuermagier befinden sich innerhalb der Burg. Allerdings gehört die Burg zum Alten Lager und darf nur von Leuten betreten werden, die zu Gomez gehören.");
};
...
instance INFO_DIEGO_MüNZEN(C_Info)
{
	...
	permanent = 0;
	description = "Ich hab' gehört du sammelst alte Münzen?";
};
...
{
	AI_Output(hero,self,"Info_Diego_Münzen_15_00");	//Ich hab' gehört du sammelst alte Münzen?
	AI_Output(self,hero,"Info_Diego_Münzen_11_01");	//Das ist richtig. Von wem hast du das denn gehört?
	AI_Output(self,hero,"Info_Diego_Münzen_11_02");	//Ach ist ja auch egal. Wenn du welche findest, kannst du sie gern zu mir bringen.
	AI_Output(self,hero,"Info_Diego_Münzen_11_03");	//Das machst du auch nicht umsonst. Ich geb' dir für jede Münze einen Erzbrocken.
	AI_Output(self,hero,"Info_Diego_Münzen_11_04");	//Abgemacht?
	Info_ClearChoices(info_diego_münzen);
	Info_AddChoice(info_diego_münzen,"Abgemacht.",info_diego_münzen_okay);
	Info_AddChoice(info_diego_münzen,"Ich will mehr.",info_diego_münzen_mehr);
};

func void info_diego_münzen_okay()
{
	AI_Output(hero,self,"Info_Diego_OKAY_15_00");	//Abgemacht.
	AI_Output(self,hero,"Info_Diego_OKAY_11_01");	//Gut. Bring mir alle alten Münzen die du finden kannst.
	AI_Output(self,hero,"Info_Diego_OKAY_11_02");	//Denk dran. Ich biete dir im Tausch für jede Münze einen Erzbrocken.
	Info_ClearChoices(info_diego_münzen);
};

func void info_diego_münzen_mehr()
{
	AI_Output(hero,self,"Info_Diego_MEHR_15_00");	//Ich will mehr.
	AI_Output(self,hero,"Info_Diego_MEHR_11_00");	//Mehr kann ich dir dafür nicht geben.
	AI_Output(self,hero,"Info_Diego_MEHR_11_01");	//Und in der Kolonie kannst du sonst nicht viel mit den Münzen anfangen.
	AI_Output(hero,self,"Info_Diego_MEHR_11_02");	//Okay, abgemacht.
	AI_Output(self,hero,"Info_Diego_MEHR_11_03");	//Gut. Bring mir alle alten Münzen die du finden kannst.
	AI_Output(self,hero,"Info_Diego_MEHR_11_04");	//Denk dran. Ich biete dir im Tausch für jede Münze einen Erzbrocken.
	Info_ClearChoices(info_diego_münzen);
};
...
instance INFO_DIEGO_MüNZENABGEBEN(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "Hier sind meine gesammelten Münzen.";
};
...
{
	AI_Output(hero,self,"Info_Diego_MünzenAbgeben_16_01");	//Hier sind meine gesammelten Münzen.
	AI_Output(self,hero,"Info_Diego_MünzenAbgeben_12_02");	//Gute Arbeit. Gib' her.
	XP_STANDART = 1;
	...
	AI_Output(self,hero,"Info_Diego_MünzenAbgeben_12_03");	//So, hier ist wie vereinbart für jede Münze ein Brocken Erz.
	...
	AI_Output(self,hero,"Info_Diego_MünzenAbgeben_12_04");	//Falls du wieder welche findest, weißt du bei wem du sie los wirst.
};
...
{
	AI_Output(self,other,"DIA_Thief_SCBARON_15_00");	//Jetzt sag blos, du gehörst von nun an zu den Erzbaronen?
	AI_Output(self,other,"DIA_Thief_SCBARON_15_01");	//Hehe. Na du bist mir ja einer.
	AI_StopProcessInfos(self);
};
