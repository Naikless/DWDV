...
func void GUR_1202_CorAngar_WANNABETPL_Info()
{
	...
	else if(hero.level >= 10)
	{
		...
		B_LogEntry(GE_BECOMEGURU,"Da ich mich den Templern angeschlossen habe, kann ich nun kein Guru mehr werden.");
...
func void Info_CorAngar_FindHerb_Info()
{
	...
	AI_Output(self,other,"Mis_3_NC_CorAngar_FindHerb_08_06");	//Wenn du die Heilkräuter hast, geh' zu Caine. Er wird dir einen Heiltrank daraus brauen können.
	...
	B_LogEntry(CH3_FindHerbs,"Y'Berion liegt immer noch im Koma. Cor Angar bat mich, fünf Heilkräuter der stärksten Sorte zu sammeln. Wenn ich die Heilkräuter habe, soll ich Caine, der mir dann daraus einen starken Heiltrank brauen wird.");
};
...
instance Info_CorAngar_FindHerb_Success(C_Info)
{
	...
	permanent = 0;
	description = "Ich habe den Heiltrank für Y'Berion.";
};
...
{
	var C_Npc YBerion;
	AI_Output(other,self,"Info_CorAngar_Find_Success_15_01");	//Ich habe den Heiltrank für Y'Berion.
	...
	B_LogEntry(CH3_FindHerbs,"Ich habe Cor Angar den benötigten Heiltrank gebracht. Bleibt nur noch zu hoffen, dass meine Hilfe rechtzeitig kam.");
