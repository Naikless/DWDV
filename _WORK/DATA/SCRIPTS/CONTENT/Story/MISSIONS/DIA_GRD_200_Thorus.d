...
func void Info_Thorus_MordragKo_Analyze_Info()
{
	...
	Info_AddChoice(Info_Thorus_MordragKo_Analyze,"Wo finde ich Mordrag?",Info_Thorus_MordragKo_Where);
	Mordrag = Hlp_GetNpc(ORG_826_Mordrag);
...
func void Info_Thorus_Give1000Ore_Info()
{
	...
	if(Npc_HasItems(other,ItMiNugget) >= 1000)
	{
		...
		ERZBEZAHLT = TRUE;
		B_LogEntry(CH1_MESSAGEKDF,"Ich habe Thorus 1000 Brocken Erz bezahlt um in die Burg zu dürfen. Jetzt werde ich den Feuermagiern die Nachricht überbringen können.");
	}
	else
	{
...
func void Info_Thorus_Krautbote_Info()
{
	...
	{
		AI_Output(self,other,"Info_Thorus_Krautbote_09_04");	//Das kann ja jeder behaupten. Und dein Amulett hast du verlegt, was?
	};
};
...
func void GRD_200_Thorus_AUFNAHME_Info()
{
	...
	AI_Output(self,other,"GRD_200_Thorus_AUFNAHME_Info_09_12");	//Deine erste Aufgabe erwartet dich im Burginneren.
	AI_Output(self,other,"GRD_200_Thorus_AUFNAHME_Info_09_13");	//Die Jungs vom Konvoi könnten deine Hilfe gebrauchen. Red' mal mit Ramon.
	KDFWache = Hlp_GetNpc(GRD_245_Gardist);
...
{
	AI_Output(self,other,"DIA_Thorus_SCBARON_15_00");	//Du bist jetzt Erzbaron? Mann, ich bin wirklich beeindruckt. Du bist ein außergewöhnlicher Kerl.
	AI_Output(self,other,"DIA_Thorus_SCBARON_15_01");	//Hätte ich dir ja damals nicht zugetraut, dass du es so weit bringst.
	AI_Output(self,other,"DIA_Thorus_SCBARON_15_02");	//Jetzt bist du ganz oben angelangt.
	AI_StopProcessInfos(self);
};
