...
{
	TA_Meditate(0,0,7,0,"WP_CIRCLE_NYRAS");
	TA_Meditate(7,0,24,0,"WP_CIRCLE_NYRAS");
};

func void rtn_afterritual_1303()
{
	TA_SitAround(0,0,7,0,"WP_HUNTERS_CAMP_04");
	TA_SitAround(7,0,24,0,"WP_HUNTERS_CAMP_04");
};
