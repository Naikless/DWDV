...
{
	TA_GuardWheelOpen(8,0,20,0,"OCR_NORTHGATE_VWHEEL");
	TA_GuardWheelOpen(20,0,8,0,"OCR_NORTHGATE_VWHEEL");
};

func void Rtn_start_228()
{
	TA_GuardWheelOpen(7,0,20,0,"OCR_NORTHGATE_VWHEEL");
	TA_GuardWheelOpen(20,0,7,0,"OCR_NORTHGATE_VWHEEL");
};
