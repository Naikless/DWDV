...
instance Vlk_580_Grim(Npc_Default)
{
	...
	Mdl_SetVisualBody(self,"hum_body_Naked0",7,1,"Hum_Head_Thief",72,2,vlk_armor_m);
	B_Scale(self);
...
func void Rtn_Start_580()
{
	...
	TA_RepairHut(7,0,9,30,"OCR_AT_HUT_2");
	TA_StandAround(9,30,10,0,"OCR_CAMPFIRE_A_MOVEMENT2");
	...
	TA_RepairHut(18,5,20,30,"OCR_AT_HUT_2");
	TA_SitCampfire(20,30,23,1,"OCR_CAMPFIRE_A_MOVEMENT2");
};
...
func void rtn_follow_580()
{
	TA_FollowPC(23,0,16,0,"OCR_HUT_2");
	TA_FollowPC(16,0,23,0,"OCR_HUT_2");
};
