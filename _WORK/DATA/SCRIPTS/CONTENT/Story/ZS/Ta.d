...
func void ta_teaching_cadar(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_teaching_cadar,waypoint);
};

func void ta_listen_cadar(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_listen_cadar,waypoint);
};

func void ta_arenafight(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_arenafight,waypoint);
};

func void ta_drunk(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_drunk,waypoint);
};

func void ta_sleep_shadowb(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_sleep_shadowb,waypoint);
};
