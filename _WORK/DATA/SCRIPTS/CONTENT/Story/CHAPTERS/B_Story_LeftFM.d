...
func void B_Story_LeftFM()
{
	...
	Npc_ExchangeRoutine(Sld_709_Cord,"FMFREE");
	Npc_ExchangeRoutine(Sld_735_Soeldner,"FMFREE");
	Npc_ExchangeRoutine(Sld_736_Soeldner,"FMFREE");
	if(FMC_SMITH == LOG_SUCCESS)
	{
		Npc_ExchangeRoutine(SLD_704_Blade,"FMFREE");
	};
	Npc_ExchangeRoutine(SFB_1001_Schuerfer,"FMFREE");
