...
func void Info_grd_7_WichtigePersonen_Info()
{
	...
	if(Npc_GetTrueGuild(other) == GIL_EBR)
	{
		...
		AI_Output(self,other,"Info_grd_7_WichtigePersonen_07_04");	//Aber keine Sorge, wir kümmern uns hier im Außenring darum das alles glatt geht.
		AI_Output(self,other,"Info_grd_7_WichtigePersonen_07_05");	//Kannst also ruhig wieder zurück in die Burg gehen, wir haben alles unter Kontrolle.
	}
	else
	{
