...
func void info_nov_5_guruwerden_info()
{
	...
	AI_Output(self,other,"Info_Nov_5_GuruWerden_05_01");	//Das ist ziemlich schwierig. Am besten ist es, wenn du dich einfach nützlich machst und als Novize bewehrst.
	AI_Output(self,other,"Info_Nov_5_GuruWerden_05_02");	//Eines Tages wird dich Y'Berion dann auserwählen.
};
...
func void Info_Nov_5_WichtigePersonen_Info()
{
	...
	if(Kapitel <= 2)
	{
		...
		else if(Npc_GetTrueGuild(other) == GIL_GUR)
		{
			...
			AI_Output(self,other,"Info_Nov_5_WichtigePersonen_05_04");	//Ich hoffe ich erfülle meine Aufgaben zufriedenstellend und erfülle euch mit Stolz.
		};
	}
	else if(Kapitel >= 3)
	{
...
func void Info_Nov_5_DieLage_Info()
{
	...
	{
		AI_Output(other,self,"Info_Nov_5_DieLage_15_03");	//Nein, ich bin schon etwas länger hier.
	};
};
